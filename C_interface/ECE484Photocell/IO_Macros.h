...
||  Compiler:		 	AVR-GCC
||  Description:		
||    This library contains macros for 
...
|| 2.	#define BUTTON	A, 1	
|| 3.				
|| 4. 	PinMode(BUTTON, OUTPUT);	
|| 5. 	PinMode(LED, OUTPUT);		
|| 6. 	PinModeToggle(BUTTON);
|| 7. 	DigitalWrite(LED, LOW);
|| 8. 	DigitalWrite(LED, HIGH);
|| 9. 	DigitalLevelToggle(LED);
||10.	int a = DigitalRead(BUTTON);
||
*/
#include <avr/io.h>
...
#define PinMode(x, y) ( y ? _SET(DDR, x, y) : _CLEAR(DDR, x, y) )
